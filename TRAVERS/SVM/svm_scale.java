...
public class svm_scale
{
    ...
    private BufferedWriter fl_save = null;
    private DecimalFormat fm=new DecimalFormat("#.00000000");
	...
	{
		line = fp.readLine();
		if(null != line && line.length() < 2) line = null;
		return line;
	}
	...
	private void run(String []argv) throws IOException
	{
		...
		while(readline(fp) != null)
		{
			...
			fl_save.write(st.nextToken()); fl_save.write(" ");
