...
import Structures.OntologyTree;
...
public class FindPaths
{
    ...
    public static metapathModel newMetaPath(Integer bgnode)
    {
    ...
    public static metapathModel appendMetaPath(metapathModel origin, Integer node, Integer edge)
    {
    ...
    public static void Find_DFS(Integer bg, Integer len, Integer len_limit, metapathModel mm, Set<metapathModel> mp)
    {
        mp.add(mm);
    ...
    public static Boolean checkRepeat(List<Integer> lista, List<Integer> listb)
    {
    ...
    public static Set<metapathModel> getPathUnion(Set<metapathModel> mpa, Set<metapathModel> mpb)
    {
    ...
    public static Set<metapathModel> getMetaPathFromOnePath(metapathModel path)
    {
    ...
    public static Set<metapathModel> Path2MetaPath(Set<metapathModel> path)
    {
        Set<metapathModel> result = new HashSet<metapathModel>(); result.clear();
    ...
    public static Set<metapathModel> returnPath(Integer a, Integer b, Integer len)
    {
        D = len;
    ...
    public static void findPath(Integer a, Integer b, Integer len, Map<List<Integer>, Set<metapathModel>> MetaPath_Cluster)
    {
        D = len;
    ...
    public static metapathModel combine(Set<metapathModel> mpset)
    {
