...
DATASET_COLLECTION['local_MQ2008'] = DataSet('MQ2008',
                                             'BSQ_files/OnlineLearningToRank/data/MQ2008/Fold*/'
                                             , 'short', True, 41)
DATASET_COLLECTION['local_Or11b'] = DataSet('Or11b', 'BSQ_files/datas/Or11b/Fold*/', 
						'binary', True, 310
                                       		)
DATASET_COLLECTION['local_Or21b'] = DataSet('Or21b', 'BSQ_files/datas/Or21b/Fold*/', 
						'binary', True, 310
                                       		)
DATASET_COLLECTION['local_Or21o'] = DataSet('Or21o', 'BSQ_files/datas/Or21o/Fold*/', 
						'binary', True, 310
                                       		)
DATASET_COLLECTION['local_Or22b'] = DataSet('Or22b', 'BSQ_files/datas/Or22b/Fold*/', 
						'binary', True, 310
                                       		) 
DATASET_COLLECTION['local_dbpedia_11b'] = DataSet('dbpedia_11b', 'DataSets/dbpedia_11b/Fold*/', 'binary', True, 162)
DATASET_COLLECTION['local_dbpedia_21b'] = DataSet('dbpedia_21b', 'DataSets/dbpedia_21b/Fold*/', 'binary', True, 231)
DATASET_COLLECTION['local_dbpedia_21o'] = DataSet('dbpedia_21o', 'DataSets/dbpedia_21o/Fold*/', 'binary', True, 271)
DATASET_COLLECTION['local_dbpedia_22b'] = DataSet('dbpedia_22b', 'DataSets/dbpedia_22b/Fold*/', 'binary', True, 91)
DATASET_COLLECTION['local_dbpedia_rs1b'] = DataSet('dbpedia_rs1b', 'DataSets/dbpedia_rs1b/Fold*/', 'binary', True, 369)
DATASET_COLLECTION['local_dbpedia_rs2b'] = DataSet('dbpedia_rs2b', 'DataSets/dbpedia_rs2b/Fold*/', 'binary', True, 278)
DATASET_COLLECTION['local_dbpedia_rs3b'] = DataSet('dbpedia_rs3b', 'DataSets/dbpedia_rs3b/Fold*/', 'binary', True, 285)
DATASET_COLLECTION['local_dbpedia_rs4b'] = DataSet('dbpedia_rs4b', 'DataSets/dbpedia_rs4b/Fold*/', 'binary', True, 535)
DATASET_COLLECTION['local_dbpedia_rs5b'] = DataSet('dbpedia_rs5b', 'DataSets/dbpedia_rs5b/Fold*/', 'binary', True, 259)
DATASET_COLLECTION['local_yago_11b'] = DataSet('yago_11b', 'DataSets/yago_11b/Fold*/', 'binary', True, 98)
DATASET_COLLECTION['local_yago_21b'] = DataSet('yago_21b', 'DataSets/yago_21b/Fold*/', 'binary', True, 67)
DATASET_COLLECTION['local_yago_21o'] = DataSet('yago_21o', 'DataSets/yago_21o/Fold*/', 'binary', True, 91)
DATASET_COLLECTION['local_yago_22b'] = DataSet('yago_22b', 'DataSets/yago_22b/Fold*/', 'binary', True, 106)
DATASET_COLLECTION['local_yago_rs1b'] = DataSet('yago_rs1b', 'DataSets/yago_rs1b/Fold*/', 'binary', True, 181)
DATASET_COLLECTION['local_yago_rs2b'] = DataSet('yago_rs2b', 'DataSets/yago_rs2b/Fold*/', 'binary', True, 221)
DATASET_COLLECTION['local_yago_rs3b'] = DataSet('yago_rs3b', 'DataSets/yago_rs3b/Fold*/', 'binary', True, 68)
DATASET_COLLECTION['local_yago_rs4b'] = DataSet('yago_rs4b', 'DataSets/yago_rs4b/Fold*/', 'binary', True, 64)
DATASET_COLLECTION['local_yago_rs5b'] = DataSet('yago_rs5b', 'DataSets/yago_rs5b/Fold*/', 'binary', True, 409)
