...
public class InteractiveExperiment {
    ...
    public static List< Pair< Integer, List<Integer> > > ParseColdStart_Sample(String filename, Integer number)
    {
        ...
        try
        {
            ...
            {
                Scanner sc = new Scanner(new FileInputStream( new File("./datas/Semantic/HotStart/" + filename + "/SC/" + id.toString() + "/data.txt")));
    ...
    public static void Expe(String method, Integer groupperfile, String clicks, Boolean repeat)
    {
        ...
        String Expefold = "./datas/Experiments/HotStart/" + clicks + "/" + method + "/";
        String[] cs_type = {"SC"};
    ...
    public static void Experiments_HotStart(String database)
    {
    ...
    public static void main(String[] args) {
        ...
        if(JdbcUtil.URL.contains("dbpedia")) Experiments_HotStart("dbpedia");
        if(JdbcUtil.URL.contains("yago")) Experiments_HotStart("yago");
    }
}
