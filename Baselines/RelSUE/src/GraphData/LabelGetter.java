...
public class LabelGetter {
	...
	public static void convertQueries(String directory){
		...
		for(File f : files){
			...
			try {
				FileWriter fw = new FileWriter(new File("H:\\websoft\\hin\\WSDM\\开源\\Queries\\yago/"
                + i + ".txt"));
				fw.write(content);
				fw.close();
			} catch (IOException e) {
	...
	public static void main(String[] args) {
		...
		//genSingleFile(new File("H:\\websoft\\hin\\WSDM\\Queries\\dbpedia/单步单条布尔.txt"));
		convertQueries("H:\\\\websoft\\\\hin\\\\WSDM\\\\Queries\\\\yago");
	}
}
